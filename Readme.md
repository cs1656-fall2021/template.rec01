...
### Description
This is the **first lab** for the CS 1656 -- Introduction to Data Science (CS 2056) class, for the Fall 2021 semester.
...
### What to submit
For this test assignment you only need to submit `task.py` to "Recitation Lab #1" and see if you get all 100 points. In case of an error or wrong result, you can modify the file and resubmit it as many times as you want until the deadline of **Wednesday, September 15, 11:59 pm**.
